...
class ShowSessionPhoto extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      openPhoto: false,
      ...
      <React.Fragment>
          <Dialog
            ...
            <DialogContent style={{width: '500px'}}>
                <Image src={`http://localhost:3030/classSessionsPhotos?course_title=${localStorage.getItem('course_title')}&course_group=${localStorage.getItem('course_group')}&session_id=${this.props.session_id}`} />
            </DialogContent>
            <DialogActions>
...
export default withStyles(useStyles)(ShowSessionPhoto);
